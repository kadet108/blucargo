...
public class OfferWindowTest extends JFrame {
    ...
    OfferWindowTest window = this;

    public OfferWindowTest() {
...
//        panel1.add(new JLabel(logoIcon),new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.PAGE_START, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        ...
        JPanel panel6a = new RoundedPanel();
        //panel6a.setBackground(null);
        ...
        JPanel panel7a = new RoundedPanel();
        //panel7a.setBackground(null);
        ...
        JPanel panel8a = new RoundedPanel();
        ...
        JPanel panel9a = new RoundedPanel();
