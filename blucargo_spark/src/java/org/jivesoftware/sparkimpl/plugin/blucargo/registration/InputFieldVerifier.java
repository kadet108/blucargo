...
public class InputFieldVerifier {
	...
	String lacalCase = "";
	String usernameReg = "([a-zA-Z0-9]{1,20})$";
	String password;
	String emailReg = "([a-zA-Z0-9_\\.-]+)@([\\da-zA-Z\\.-]+)\\.([a-zA-Z\\.]{2,6}$)";
	String cell1Reg = "(\\+[1-9]{2}[0-9]{9})$";
	String cell2Reg = "(\\(\\+[1-9]{2}\\)\\s[0-9]{3}\\s[0-9]{3}\\s[0-9]{3}$)";
	String cell3Reg = "([0-9]{3}\\s[0-9]{3}\\s[0-9]{3}$)|[0-9]{9}$";
	...
	public int verifyCity(String city){
		return verifyNameAndSurname(city, cityReg);
	}
