...
public class FavouriteOffersInfoPanel extends VisualPanel {
	...
	public void render(final CargoOffer cargoOffer, JPanel panel, int row) {
        ...
        JButton details;
        details = new JButton("<html><font color='white'>"+StrAccessor.getString("FavouriteOffersInfoPanel.buttonDetails")+"</font></html>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		JButton remove;
		remove = new JButton("<html><font color='white'>"+StrAccessor.getString("FavouriteOffersInfoPanel.buttonRemove")+"</font></html>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		remove.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				CargoDataManager.getInstance().removeFavouriteOffer(cargoOffer);
