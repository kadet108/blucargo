...
public class SysTrayPlugin implements Plugin, NativeHandler, MessageEventNotificationListener {
	...
	private HotOfferPanel hotOfferPanel 	= new HotOfferPanel();
	...
	private final JMenuItem offersMenu 		= new JMenuItem("Fresh Offers");
	...
	public void initialize() {
		...
		if (SystemTray.isSupported()) {
			...
			offersMenu.addActionListener(new AbstractAction() {

				@Override
				public void actionPerformed(ActionEvent e) {
					hotOfferPanel.setVisible(true);
					offersMenu.setEnabled(false);
				}
				...
				trayIcon.addMouseListener(new MouseListener() {
					...
					public void mouseClicked(MouseEvent event) {
						if (event.getButton() == MouseEvent.BUTTON1 && event.getClickCount() == 1) {
							...
							if( y > 100){
								newY 	= y - hotOfferPanel.getHeight();
							}

							if( x > 100){
								newX 	= x - hotOfferPanel.getWidth();
							}
	
							hotOfferPanel.setLocation(newX, newY);
		...
		hotOfferPanel.addWindowListener(new WindowCloseListener(offersMenu));
		hotOfferPanel.setVisible(false);
		
		popupMenu.add(offersMenu);

		offersMenu.addMouseListener(new MouseListener(){
			...
			public void mousePressed(MouseEvent e) {
				...
				//hotOfferPanel.setLocation((int)(p.getX()-(hotOfferPanel.getSizeX())+20), e.getY());
	...
	public class WindowCloseListener extends WindowAdapter {
		...
		public WindowCloseListener(JMenuItem offMenu) {
			menu = offMenu;
		}
