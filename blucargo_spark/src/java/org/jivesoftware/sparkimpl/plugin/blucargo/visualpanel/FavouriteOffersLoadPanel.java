...
public class FavouriteOffersLoadPanel extends VisualPanel{

	private static final long serialVersionUID = -8033741727767383573L;
    ...
    public void render(CargoOffer cargoOffer, JPanel panel, int row){
        ...
        //obrazek         
        //ImageIcon countryIcon = new ImageIcon("images/cargo/countries/PL.png");
