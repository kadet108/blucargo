...
import org.jivesoftware.sparkimpl.plugin.blucargo.window.util.ComponentCreator;
...
//                final JPanel topPanel = new BackgroundPanel();
                final JPanel topPanel = ComponentCreator.createBlueTopPanel();
                ...
                final JPanel bottom = ComponentCreator.createBlueBottomPanel();
                bottom.setLayout(new GridBagLayout());
                
                bottom.add(searchField, new GridBagConstraints(1, 0, GridBagConstraints.REMAINDER, 1, 1.0, 1.0, GridBagConstraints.SOUTHEAST, GridBagConstraints.NONE, new Insets(1, 1, 6, 1), 0, 0));
    ...
    private class ChatRoomDecorator implements ActionListener, ChatRoomClosingListener {
        ...
        public ChatRoomDecorator(ChatRoom chatRoom) {
            ...
            chatHistoryButton = new CargoChatRoomButton("", SparkRes.getImageIcon(SparkRes.SPARK_IKONKA_HISTORIA));
            ...
            chatHistoryButton.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
