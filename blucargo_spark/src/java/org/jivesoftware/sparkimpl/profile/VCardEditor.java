...
import org.jivesoftware.sparkimpl.plugin.blucargo.window.EmployeeListPanel;
...
//    private EmployeePanel 		employeePanel;
    ...
    public void editProfile(final VCard vCard, JComponent parent) {
        ...
        if (vCard.getJabberId() == SparkManager.getUserManager().getJIDFromDisplayName(SparkManager.getUserManager().getNickname())){
...
//        tabbedPane.addTab("Pracownicy", employeePanel);
    ...
    private void preSaveVCard(){
    	
    	if(!employee){
    		boolean result = employeeListPanel.saveEmployees();
