...
public final class Spark {
    ...
    public static void installBaseUIProperties() {
        ...
        UIManager.put("List.selectionBackground", new Color(219, 213, 192));
        UIManager.put("List.selectionForeground", Color.black);
        //UIManager.put("List.selectionBorder", new Color(187, 195, 215));
        UIManager.put("List.selectionBorder", new Color(209, 202, 174));
        UIManager.put("List.foreground", Color.black);
        UIManager.put("List.background", Color.white);
        //UIManager.put("MenuItem.selectionBackground", new Color(217, 232, 250));
        UIManager.put("MenuItem.selectionBackground", new Color(219, 213, 192));
        ...
        UIManager.put("ContactItem.background", new Color(232, 227, 208));
