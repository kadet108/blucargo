...
public class Workspace extends JPanel implements PacketListener {
    ...
    private Workspace() {
        ...
        tabbedPane = new JTabbedPane();
       	tabbedPane.addTab("Okno Glowne", workspacePane);
        ...
        commandPanel = new CommandPanel(2);
        commandPanel1 = new CommandPanel();

        this.setLayout(new GridBagLayout());
        add(commandPanel1, 		new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        add(commandPanel,  		new GridBagConstraints(0, 2, 1, 3, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        add(tabbedPane,		 	new GridBagConstraints(0, 5, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        add(statusBox,     		new GridBagConstraints(0, 9, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        ...
        setBackground(new Color(246, 245, 215));
    }
    ...
    public void loadPlugins() {
        ...
        cargoPlugin=new BlucargoPlugin();
        cargoPlugin.initialize();
    ...
    public CommandPanel getCommandPanel1() {
