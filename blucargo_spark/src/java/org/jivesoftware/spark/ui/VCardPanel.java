...
public class VCardPanel extends JPanel {
    ...
    public VCardPanel(final String jid) {
        ...
        add(avatarImage, new GridBagConstraints(0, 0, 1, 3, 0.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(17, 10, 5, 0), 0, 0));
    ...
    private void buildUI(final VCard vcard) {
        ...
        add(usernameLabel, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(25, 5, 0, 0), 0, 0));
