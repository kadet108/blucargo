...
import org.jivesoftware.sparkimpl.plugin.blucargo.visual.VerticalGradientPanel;
...
public abstract class ChatRoom extends BackgroundPanel implements ActionListener, PacketListener, DocumentListener, ConnectionListener, FocusListener, ContextMenuListener {
    ...
    protected ChatRoom() {
        ...
        toolbar.setPreferredSize(new Dimension(500, 71));
        toolbar.setMaximumSize(new Dimension(500, 71));
        toolbar.setMinimumSize(new Dimension(500, 71));

        Color startColor = new Color(89,105,130);
        Color endColor = new Color(130, 145, 164);
        
        bottomPanel = new VerticalGradientPanel(startColor, endColor);
     ...
     */
    public class ChatToolBar extends BackgroundPanel {
        ...
        public ChatToolBar() {
    		...
    		this.setBackgroundImage(pasekMenuTlo);

//        	buttonPanel = ComponentCreator.createBlueTopPanel();
...
//            buttonPanel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
            add(buttonPanel, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE, new Insets(20, 0, 0, 20), 0, 0));
            setOpaque(false);
        }
