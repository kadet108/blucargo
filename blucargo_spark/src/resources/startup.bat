...
java -Dappdir=.. -cp ../lib/hibernate-annotations.jar;../lib/hibernate-commons-annotations.jar;../lib/hibernate-entitymanager.jar;../lib/hibernate3.jar;../lib/openjpa-all-2.0.0.jar;../lib/jdom.jar;../lib/log4j.jar;../lib/lti-civil.jar;../lib/fmj.jar;../lib/startup.jar;../lib/windows/jdic.jar;../resources;../lib/windows; -Djava.library.path="../lib/windows" org.jivesoftware.launcher.Startup
goto end
